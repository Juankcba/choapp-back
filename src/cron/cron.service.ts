...
export class CronService {
    ...
    // Crons de payouts (settleReleasablePayouts, cancelUnpaidUpcomingSessions,
    // remindOverduePayouts) eliminados el 2026-04-19 junto con la integración
    // de MercadoPago. CHO no retiene ni libera fondos; sin gate de pago,
    // tampoco hay sesiones que cancelar por falta de pago.
}
